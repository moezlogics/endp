...
export type BlogPost = {
  ...
  categories: Array<Maybe<BlogCategory>>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
};
...
export type Banner = {
  ...
  image_url_mobile: Maybe<Scalars['String']['output']>;
  link_url: Maybe<Scalars['String']['output']>;
  cta_label: Maybe<Scalars['String']['output']>;
  text_position: Scalars['String']['output'];
...
export type ContactLeadStatusEnum =
  | 'new'
  | 'read'
  | 'replied'
  | 'archived';
...
export type ContactLead = {
  ...
  status: ContactLeadStatusEnum;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
};

export type AdvancedReviewStatusEnum =
  | 'pending'
  | 'approved'
  | 'flagged';

export type AdvancedReview = {
  __typename?: 'AdvancedReview';
  id: Scalars['ID']['output'];
  ...
  status: AdvancedReviewStatusEnum;
  owner_reply: Maybe<Scalars['String']['output']>;
...
export type PushSubscription = {
  ...
  device_browser: Maybe<Scalars['String']['output']>;
  device_type: Maybe<Scalars['String']['output']>;
  os: Maybe<Scalars['String']['output']>;
  locale: Maybe<Scalars['String']['output']>;
  timezone: Maybe<Scalars['String']['output']>;
  subscribe_source: Maybe<Scalars['String']['output']>;
  is_active: Scalars['Boolean']['output'];
  gender: Maybe<Scalars['String']['output']>;
  last_sent_at: Maybe<Scalars['DateTime']['output']>;
  total_clicked: Scalars['Int']['output'];
  last_clicked_at: Maybe<Scalars['DateTime']['output']>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
};

export type PushCampaignStatusEnum =
  | 'draft'
  | 'sending'
  | 'sent'
  | 'failed';
...
export type PushCampaign = {
  ...
  filter_cities: Maybe<Scalars['String']['output']>;
  filter_states: Maybe<Scalars['String']['output']>;
  filter_countries: Maybe<Scalars['String']['output']>;
  filter_device_types: Maybe<Scalars['String']['output']>;
  filter_os: Maybe<Scalars['String']['output']>;
  filter_browsers: Maybe<Scalars['String']['output']>;
  filter_genders: Maybe<Scalars['String']['output']>;
  filter_customers_only: Scalars['Boolean']['output'];
  total_targeted: Scalars['Int']['output'];
  total_sent: Scalars['Int']['output'];
  total_failed: Scalars['Int']['output'];
  total_clicked: Scalars['Int']['output'];
  status: PushCampaignStatusEnum;
...
export type AdminPushSubscription = {
  __typename?: 'AdminPushSubscription';
  id: Scalars['ID']['output'];
  endpoint: Scalars['String']['output'];
  p256dh: Scalars['String']['output'];
  auth: Scalars['String']['output'];
...
export type OtpCodePurposeEnum =
  | 'signup'
  | 'password_reset'
  | 'email_verify';
...
export type LoyaltyTransactionKindEnum =
  | 'earn'
  | 'redeem'
  | 'adjust'
  | 'refund';
...
export type LoyaltyTransaction = {
  ...
  kind: LoyaltyTransactionKindEnum;
...
export type Bundle = {
  ...
  id: Scalars['ID']['output'];
  title: Scalars['String']['output'];
  items: Array<Maybe<BundleItem>>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  product_link: Maybe<LinkBundledProductBundleProductProduct>;
...
export type BundleItem = {
  ...
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  product_link: Maybe<LinkBundledProductBundleItemProductProduct>;
  product: Maybe<Product>;
};
...
export type ChatSession = {
  ...
  id: Scalars['ID']['output'];
  customer_id: Maybe<Scalars['String']['output']>;
  visitor_token: Maybe<Scalars['String']['output']>;
  title: Maybe<Scalars['String']['output']>;
...
export type SpecTemplate = {
  __typename?: 'SpecTemplate';
  id: Scalars['ID']['output'];
  name: Scalars['String']['output'];
  handle: Scalars['String']['output'];
  description: Maybe<Scalars['String']['output']>;
  icon: Scalars['String']['output'];
  is_preset: Scalars['Boolean']['output'];
  sort_order: Scalars['Int']['output'];
...
export type Product = {
  ...
  bundle_item_link: Maybe<Array<Maybe<LinkBundledProductBundleItemProductProduct>>>;
  bundle_items: Maybe<Array<Maybe<BundleItem>>>;
  bundle_link: Maybe<LinkBundledProductBundleProductProduct>;
  bundle: Maybe<Bundle>;
};
...
export type LinkBundledProductBundleItemProductProduct = {
  __typename?: 'LinkBundledProductBundleItemProductProduct';
  bundle_item_id: Scalars['String']['output'];
  product_id: Scalars['String']['output'];
  bundle_item: Maybe<BundleItem>;
  product: Maybe<Product>;
  createdAt: Scalars['String']['output'];
  updatedAt: Scalars['String']['output'];
  deletedAt: Maybe<Scalars['String']['output']>;
...
export type LinkBundledProductBundleProductProduct = {
  __typename?: 'LinkBundledProductBundleProductProduct';
  bundle_id: Scalars['String']['output'];
  product_id: Scalars['String']['output'];
  bundle: Maybe<Bundle>;
  product: Maybe<Product>;
...
declare module '@medusajs/framework/types' {
  interface RemoteQueryEntryPoints {
    ...
    advanced_reviews: AdvancedReview
    brand: Brand
    brands: Brand
    ...
    admin_push_subscription: AdminPushSubscription
    ...
    bundle_item_product: LinkBundledProductBundleItemProductProduct
    bundle_product: LinkBundledProductBundleProductProduct
  }
}