...
export const env = {
    ...
    CDN_PUBLIC_URL: process.env.CDN_PUBLIC_URL || "http://localhost:3051",
    ...
    CORS_ORIGINS: (process.env.CORS_ORIGINS || "http://localhost:3050,http://localhost:3052,http://localhost:3051")
        .split(",")
        .map((o) => o.trim()),
