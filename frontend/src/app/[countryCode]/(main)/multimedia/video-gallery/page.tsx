...
export const metadata: Metadata = {
  ...
  description: "Polio Eradication Pakistan Video Gallery – Vaccination Campaigns, Awareness Films & Field Documentaries | End Polio Pakistan — this page provides comprehen...",
  alternates: {
...
export default function Page() {
  const content = `<p>Polio Eradication Pakistan Video Gallery – Vaccination Campaigns, Awareness Films & Field Documentaries | End Polio Pakistan — this page provides comprehensive information about a key aspect of Pakistan's polio eradication programme. As one of the world's most complex public health initiatives, the programme encompasses vaccination campaigns, disease surveillance, community engagement, and cross-border coordination — all working together toward the goal of eliminating poliovirus from its last remaining strongholds.</p>
