...
export const metadata: Metadata = {
  ...
  description: "IPV Polio Vaccine Training Video Pakistan – Correct Administration Guide for Health Workers | End Polio Pakistan — this page provides comprehensive informa...",
  alternates: {
...
export default function Page() {
  const content = `<p>IPV Polio Vaccine Training Video Pakistan – Correct Administration Guide for Health Workers | End Polio Pakistan — this page provides comprehensive information about a key aspect of Pakistan's polio eradication programme. As one of the world's most complex public health initiatives, the programme encompasses vaccination campaigns, disease surveillance, community engagement, and cross-border coordination — all working together toward the goal of eliminating poliovirus from its last remaining strongholds.</p>
