...
export const metadata: Metadata = {
  ...
  description: "Polio Cases District Wise – 2015 — this page provides comprehensive information about a key aspect of Pakistan's polio eradication programme. As one of the...",
  alternates: {
