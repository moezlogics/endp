...
export const metadata: Metadata = {
  ...
  description: "Core Team | Polio in Pakistan — this page provides comprehensive information about a key aspect of Pakistan's polio eradication programme. As one of the wo...",
  alternates: {
