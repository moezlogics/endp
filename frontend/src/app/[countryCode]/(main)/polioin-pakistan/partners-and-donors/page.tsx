...
export const metadata: Metadata = {
  ...
  description: "Partners and Donors | Polio in Pakistan — this page provides comprehensive information about a key aspect of Pakistan's polio eradication programme. As one...",
  alternates: {
