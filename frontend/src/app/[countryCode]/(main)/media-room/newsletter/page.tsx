...
export const metadata: Metadata = {
  ...
  description: "End Polio Pakistan Newsletter – Monthly Programme Updates, Campaign Results & Frontline Stories | End Polio Pakistan — this page provides comprehensive inf...",
  alternates: {
...
export default function Page() {
  const content = `<p>End Polio Pakistan Newsletter – Monthly Programme Updates, Campaign Results & Frontline Stories | End Polio Pakistan — this page provides comprehensive information about a key aspect of Pakistan's polio eradication programme. As one of the world's most complex public health initiatives, the programme encompasses vaccination campaigns, disease surveillance, community engagement, and cross-border coordination — all working together toward the goal of eliminating poliovirus from its last remaining strongholds.</p>
