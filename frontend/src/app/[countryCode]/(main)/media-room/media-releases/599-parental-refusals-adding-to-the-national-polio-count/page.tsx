...
export const metadata: Metadata = {
  ...
  description: "Parental Refusals Adding to the National Polio Count — this page provides comprehensive information about a key aspect of Pakistan's polio eradication prog...",
  alternates: {
