...
export const metadata: Metadata = {
  ...
  description: "Children Remain at Risk Due to Low Immunization — this page provides comprehensive information about a key aspect of Pakistan's polio eradication programme...",
  alternates: {
