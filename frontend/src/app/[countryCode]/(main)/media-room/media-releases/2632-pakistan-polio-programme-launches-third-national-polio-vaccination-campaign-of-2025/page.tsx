...
export const metadata: Metadata = {
  ...
  description: "Third National Polio Vaccination Campaign 2025 Pakistan – Programme Launch, Coverage Targets & Key Details | End Polio Pakistan — this vaccination campaign...",
  alternates: {
