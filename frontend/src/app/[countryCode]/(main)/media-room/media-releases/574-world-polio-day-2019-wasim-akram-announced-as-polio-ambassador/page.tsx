...
export const metadata: Metadata = {
  ...
  description: "World Polio Day 2019: Wasim Akram Announced as Polio Ambassador — this page provides comprehensive information about a key aspect of Pakistan's polio eradi...",
  alternates: {
