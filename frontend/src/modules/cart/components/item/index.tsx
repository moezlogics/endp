...
export default function Item({ item, type = "full", currencyCode }: ItemProps) {
  ...
  // Whether this line item carries a Rx flag — surfaces a tiny amber
  // chip on the card so the user is reminded before checkout.
        ...
        <div className="min-w-0">
          <div className="flex items-start gap-2">
            ...
            {requiresPrescription && (
              <span
                className="shrink-0 text-[9px] font-bold tracking-wide uppercase text-amber-700 bg-amber-100 rounded-md px-1.5 py-0.5"
